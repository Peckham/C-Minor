...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000033943e9100000000723ad7d1(
...
class phpbbtemplatetwiglexer_0000000033943e9100000000723ad7d1 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5c110c9bc59ce894156894 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5c110c9bc59d8852532916 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5c110c9bc59aa472734263 = array(
    ...
    {
        $this->initializer5c110c9bc59d8852532916 && ($this->initializer5c110c9bc59d8852532916->__invoke($valueHolder5c110c9bc59ce894156894, $this, 'set_environment', array('env' => $env), $this->initializer5c110c9bc59d8852532916) || 1) && $this->valueHolder5c110c9bc59ce894156894 = $valueHolder5c110c9bc59ce894156894;

        return $this->valueHolder5c110c9bc59ce894156894->set_environment($env);
    }
    ...
    {
        $this->initializer5c110c9bc59d8852532916 && ($this->initializer5c110c9bc59d8852532916->__invoke($valueHolder5c110c9bc59ce894156894, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5c110c9bc59d8852532916) || 1) && $this->valueHolder5c110c9bc59ce894156894 = $valueHolder5c110c9bc59ce894156894;

        return $this->valueHolder5c110c9bc59ce894156894->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5c110c9bc59d8852532916 && ($this->initializer5c110c9bc59d8852532916->__invoke($valueHolder5c110c9bc59ce894156894, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5c110c9bc59d8852532916) || 1) && $this->valueHolder5c110c9bc59ce894156894 = $valueHolder5c110c9bc59ce894156894;

        return $this->valueHolder5c110c9bc59ce894156894->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5c110c9bc59d8852532916 = $initializer;
    }
    ...
    {
        $this->initializer5c110c9bc59d8852532916 && ($this->initializer5c110c9bc59d8852532916->__invoke($valueHolder5c110c9bc59ce894156894, $this, '__get', array('name' => $name), $this->initializer5c110c9bc59d8852532916) || 1) && $this->valueHolder5c110c9bc59ce894156894 = $valueHolder5c110c9bc59ce894156894;

        if (isset(self::$publicProperties5c110c9bc59aa472734263[$name])) {
            return $this->valueHolder5c110c9bc59ce894156894->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c110c9bc59ce894156894;
    ...
    {
        $this->initializer5c110c9bc59d8852532916 && ($this->initializer5c110c9bc59d8852532916->__invoke($valueHolder5c110c9bc59ce894156894, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5c110c9bc59d8852532916) || 1) && $this->valueHolder5c110c9bc59ce894156894 = $valueHolder5c110c9bc59ce894156894;
    ...
    {
        $this->initializer5c110c9bc59d8852532916 && ($this->initializer5c110c9bc59d8852532916->__invoke($valueHolder5c110c9bc59ce894156894, $this, '__isset', array('name' => $name), $this->initializer5c110c9bc59d8852532916) || 1) && $this->valueHolder5c110c9bc59ce894156894 = $valueHolder5c110c9bc59ce894156894;
    ...
    {
        $this->initializer5c110c9bc59d8852532916 && ($this->initializer5c110c9bc59d8852532916->__invoke($valueHolder5c110c9bc59ce894156894, $this, '__unset', array('name' => $name), $this->initializer5c110c9bc59d8852532916) || 1) && $this->valueHolder5c110c9bc59ce894156894 = $valueHolder5c110c9bc59ce894156894;
    ...
    {
        $this->initializer5c110c9bc59d8852532916 && ($this->initializer5c110c9bc59d8852532916->__invoke($valueHolder5c110c9bc59ce894156894, $this, '__clone', array(), $this->initializer5c110c9bc59d8852532916) || 1) && $this->valueHolder5c110c9bc59ce894156894 = $valueHolder5c110c9bc59ce894156894;

        $this->valueHolder5c110c9bc59ce894156894 = clone $this->valueHolder5c110c9bc59ce894156894;
    }

    public function __sleep()
    {
        $this->initializer5c110c9bc59d8852532916 && ($this->initializer5c110c9bc59d8852532916->__invoke($valueHolder5c110c9bc59ce894156894, $this, '__sleep', array(), $this->initializer5c110c9bc59d8852532916) || 1) && $this->valueHolder5c110c9bc59ce894156894 = $valueHolder5c110c9bc59ce894156894;

        return array('valueHolder5c110c9bc59ce894156894');
    }
    ...
    {
        return $this->initializer5c110c9bc59d8852532916;
    }
    ...
    {
        return $this->initializer5c110c9bc59d8852532916 && ($this->initializer5c110c9bc59d8852532916->__invoke($valueHolder5c110c9bc59ce894156894, $this, 'initializeProxy', array(), $this->initializer5c110c9bc59d8852532916) || 1) && $this->valueHolder5c110c9bc59ce894156894 = $valueHolder5c110c9bc59ce894156894;
    }
    ...
    {
        return null !== $this->valueHolder5c110c9bc59ce894156894;
    }
    ...
    {
        return $this->valueHolder5c110c9bc59ce894156894;
    }
