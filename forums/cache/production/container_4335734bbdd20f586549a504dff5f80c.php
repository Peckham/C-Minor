...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000049dd2d5400000000231c0d39(
...
class phpbbtemplatetwiglexer_0000000049dd2d5400000000231c0d39 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5c110f8dc5863674601393 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5c110f8dc586c768623976 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5c110f8dc5841460054999 = array(
    ...
    {
        $this->initializer5c110f8dc586c768623976 && ($this->initializer5c110f8dc586c768623976->__invoke($valueHolder5c110f8dc5863674601393, $this, 'set_environment', array('env' => $env), $this->initializer5c110f8dc586c768623976) || 1) && $this->valueHolder5c110f8dc5863674601393 = $valueHolder5c110f8dc5863674601393;

        return $this->valueHolder5c110f8dc5863674601393->set_environment($env);
    }
    ...
    {
        $this->initializer5c110f8dc586c768623976 && ($this->initializer5c110f8dc586c768623976->__invoke($valueHolder5c110f8dc5863674601393, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5c110f8dc586c768623976) || 1) && $this->valueHolder5c110f8dc5863674601393 = $valueHolder5c110f8dc5863674601393;

        return $this->valueHolder5c110f8dc5863674601393->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5c110f8dc586c768623976 && ($this->initializer5c110f8dc586c768623976->__invoke($valueHolder5c110f8dc5863674601393, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5c110f8dc586c768623976) || 1) && $this->valueHolder5c110f8dc5863674601393 = $valueHolder5c110f8dc5863674601393;

        return $this->valueHolder5c110f8dc5863674601393->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5c110f8dc586c768623976 = $initializer;
    }
    ...
    {
        $this->initializer5c110f8dc586c768623976 && ($this->initializer5c110f8dc586c768623976->__invoke($valueHolder5c110f8dc5863674601393, $this, '__get', array('name' => $name), $this->initializer5c110f8dc586c768623976) || 1) && $this->valueHolder5c110f8dc5863674601393 = $valueHolder5c110f8dc5863674601393;

        if (isset(self::$publicProperties5c110f8dc5841460054999[$name])) {
            return $this->valueHolder5c110f8dc5863674601393->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c110f8dc5863674601393;
    ...
    {
        $this->initializer5c110f8dc586c768623976 && ($this->initializer5c110f8dc586c768623976->__invoke($valueHolder5c110f8dc5863674601393, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5c110f8dc586c768623976) || 1) && $this->valueHolder5c110f8dc5863674601393 = $valueHolder5c110f8dc5863674601393;
    ...
    {
        $this->initializer5c110f8dc586c768623976 && ($this->initializer5c110f8dc586c768623976->__invoke($valueHolder5c110f8dc5863674601393, $this, '__isset', array('name' => $name), $this->initializer5c110f8dc586c768623976) || 1) && $this->valueHolder5c110f8dc5863674601393 = $valueHolder5c110f8dc5863674601393;
    ...
    {
        $this->initializer5c110f8dc586c768623976 && ($this->initializer5c110f8dc586c768623976->__invoke($valueHolder5c110f8dc5863674601393, $this, '__unset', array('name' => $name), $this->initializer5c110f8dc586c768623976) || 1) && $this->valueHolder5c110f8dc5863674601393 = $valueHolder5c110f8dc5863674601393;
    ...
    {
        $this->initializer5c110f8dc586c768623976 && ($this->initializer5c110f8dc586c768623976->__invoke($valueHolder5c110f8dc5863674601393, $this, '__clone', array(), $this->initializer5c110f8dc586c768623976) || 1) && $this->valueHolder5c110f8dc5863674601393 = $valueHolder5c110f8dc5863674601393;

        $this->valueHolder5c110f8dc5863674601393 = clone $this->valueHolder5c110f8dc5863674601393;
    }

    public function __sleep()
    {
        $this->initializer5c110f8dc586c768623976 && ($this->initializer5c110f8dc586c768623976->__invoke($valueHolder5c110f8dc5863674601393, $this, '__sleep', array(), $this->initializer5c110f8dc586c768623976) || 1) && $this->valueHolder5c110f8dc5863674601393 = $valueHolder5c110f8dc5863674601393;

        return array('valueHolder5c110f8dc5863674601393');
    }
    ...
    {
        return $this->initializer5c110f8dc586c768623976;
    }
    ...
    {
        return $this->initializer5c110f8dc586c768623976 && ($this->initializer5c110f8dc586c768623976->__invoke($valueHolder5c110f8dc5863674601393, $this, 'initializeProxy', array(), $this->initializer5c110f8dc586c768623976) || 1) && $this->valueHolder5c110f8dc5863674601393 = $valueHolder5c110f8dc5863674601393;
    }
    ...
    {
        return null !== $this->valueHolder5c110f8dc5863674601393;
    }
    ...
    {
        return $this->valueHolder5c110f8dc5863674601393;
    }
