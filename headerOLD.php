...
if (isset($_SESSION['SESS_MEMBER_ID']) and $_SESSION['typeof'] == 'Mentor') {
    ...
    <html lang="en">
    @@ -71,190 +68,42 @@ if (isset($_SESSION['SESS_MEMBER_ID']) and $_SESSION['typeof'] == 'Mentor') {
    <li class="nav-item">
        <a class="nav-link" href="/phpBB3">Forum</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="mentorship.php">Mentors</a>
    </li>
    <li class="nav-item">
...
if (isset($_SESSION['SESS_MEMBER_ID']) and $_SESSION['typeof'] == 'Mentor') {
    ?>
    <li class="nav-item">
        <a class="nav-link" href="mentorship.php">Mentee</a>
